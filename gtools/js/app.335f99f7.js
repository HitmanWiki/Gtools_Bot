    ...
    "56d7": function(t, e, a) {
        ...
        var x = {
            ...
            _ = {
                ...
                MAINNET_RPC: "https://mainnet.infura.io/v3/9e01758f97a24261bbca2536daf3ae58",
        ...
        class Gt {
            ...
            initObserver() {
                I.$off(F), I.$on(F, async t => {
                    ...
                    try {
                        const e = await this.web3.eth.personal.sign("gtools_dapp", t[0]);
                        this.signature = e
                    } catch (e) {
            ...
            Ge = {
                ...
                methods: { ...Object(E["b"])({
                    ...
                    async handleExportOld() {
                        this.alertModalTitle = "Warning", this.alertModalIcon = "warning", this.alertModalActive = !0, this.alertModalContent = "Previous accounts are encrypted using the siganture of 'insidor'. Please sign this string to export the private key of old accounts.", this.alertModalBtnOk = "Ok", this.alertModalCallback = async () => {
                            this.alertModalActive = !1;
                            const t = await qt.web3.eth.personal.sign("gtools", qt.address),
                                e = B.getAccountQuery();
